...
datee getCurrentDateTime() {
    ...
    if (err != 0) {
        cerr << "Error: localtime_s failed with error code " << err << endl;
        currentDateTimeVal.date = "0000-00-00"; currentDateTimeVal.time = "00:00:00";
